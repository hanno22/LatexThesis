...
\begin{document}
	...
	(... Interpretation Ortsraum schwierig)
	...
	\begin{figure}
		...
		\caption[PSHE Messung von \cite{OConnor.2014}]{Die Abbildung zeigt die PSHE Messungen von \cite{OConnor.2014} an einer mit der \textit{drop and cast} Methode platzierten $60\,\mathrm{nm}$ großen Goldkugel. Der Verlauf der Intensitäten zeigt deutliche Ähnlichkeit mit den in dieser Arbeit durchgeführten Messungen in Rückwärtsrichtung (Abbildung \ref{fig:int_fp_45_135} und \ref{fig:intensity_back}).}
